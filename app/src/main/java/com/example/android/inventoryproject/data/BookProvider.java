...
public class BookProvider extends ContentProvider{
    ...
    private Uri insertBook(Uri uri, ContentValues values) {
        ...
        // If the phone is provided, check that it's greater than or equal to 0
        Integer phone = values.getAsInteger(BookEntry.COLUMN_BOOK_SUPPLIER_PHONE);
    ...
    private int updateBook(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        if (values.containsKey(BookEntry.COLUMN_BOOK_SUPPLIER_PHONE)) {
            // Check that the phone is greater than or equal to 0
            Integer phone = values.getAsInteger(BookEntry.COLUMN_BOOK_SUPPLIER_PHONE);
            if (phone != null && phone < 0) {
                throw new IllegalArgumentException("Book requires valid supplier phone");
            }
